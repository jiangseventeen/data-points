...
import ChartSplitLine from './ChartSplitLine'
import ComponentTitle from './ComponentTitle'
import CoordinateConfig from './CoordinateConfig'

Vue.component('Icon', Icon)
Vue.component('DpColor', DpColor)
...
Vue.component('ChartSplitLine', ChartSplitLine)
Vue.component('ComponentTitle', ComponentTitle)
Vue.component('CoordinateConfig', CoordinateConfig)